...
class ParquetTarget(BaseDaskTarget):
    # Luigi target for Dask Parquet collection.
...
class CSVTarget(BaseDaskTarget):
    # Luigi target for Dask CSV collection.
    def __init__(self, path, glob="yelp_subset_*.csv", flag=None, storage_options=None): 
        self.path=path
        self.flag=flag
        self.glob=glob
        self.storage_options=storage_options
        super(CSVTarget,self).__init__(path,glob,flag,storage_options)  
